                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 0761229114</p>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.facebook.com/profile.php?id=100063627923092" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
                        ...
                        <a href="https://www.linkedin.com/company/Dtech.inc" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
